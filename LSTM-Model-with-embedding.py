...
# creating the model
model = Sequential()
model.add(Bidirectional(LSTM(neurons, return_sequences=True), input_shape=(100, 200)))  # around 50 seems good
model.add(Bidirectional(LSTM(neurons, activation='tanh')))
...
model.save(path + 'model_w2v/BiLSTM_model.h5')
print("\n\n")
